...
public class ThresholdDlg extends JDialog {
    ...
    private void okPerform() {
        ...
        if (s.matches(sPattern)) {
            ...
            if (threshold > 255) {
                JOptionPane.showMessageDialog(getContentPane(), "请不要输入255以上数字！", "系统信息", JOptionPane.WARNING_MESSAGE);
                inputArea.setText("");
            } else {
            ...
            JOptionPane.showMessageDialog(getContentPane(), "请输入0~255的数字！", "系统信息", JOptionPane.WARNING_MESSAGE);
            inputArea.setText("");
        }
    }
