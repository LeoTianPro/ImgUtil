...
public class WaveletTransform
{
	...
	public static void wavelet(float s0[], int s0Len, float p[], float q[], int sup, float s1[], float w1[]) {
		int n, k;
		int index;
	...
	public static void iwavelet(float s1[], float w1[], int s1Len, float p[], float q[], int sup, float s0[]) {
		int n, k;
		int index, ofs;
	...
	public static void wavelet2d(float s0[][], int s0Len, float s1[][], float w1v[][], float w1h[][], float w1d[][]) {
		int i, j;
		...
		int sup = 4;
		float p[] = new float[] { 0.482962913145f, 0.836516303738f, 0.224143868042f, -0.129409522551f };
		float q[] = new float[4];
		for (i = 0; i < sup; i++)
			q[i] = (float) Math.pow(-1, i) * p[sup - i - 1];

		for (i = 0; i < s0Len; i++)
			wavelet(s0[i], s0Len, p, q, sup, s1x[i], w1x[i]);
	...
	public static void iwavelet2d(float s1[][], int s1Len, float w1v[][], float w1h[][], float w1d[][], float s0[][]) {
		int i, j;
		...
		for (i = 0; i < s1Len * 2; i++)
			iwavelet(s1xt[i], w1xt[i], s1Len, p, q, sup, s0[i]);
	}
