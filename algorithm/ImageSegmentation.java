...
public class ImageSegmentation
{
	...
	public static BufferedImage dynamic(BufferedImage srcImage) {
		...
		for (int j = 0; j < height - height % 4; j = j + (height - height % 4) / 4)
		{
			...
			{
				BufferedImage tempImage = new BufferedImage((width - width % 4) / 4, (height - height % 4) / 4,
				...
				tempImage.setRGB(0, 0, (width - width % 4) / 4, (height - height % 4) / 4, tempRGBs, 0,
						(width - width % 4) / 4);
				tempImage = otsu(tempImage);
				tempRGBs = tempImage.getRGB(0, 0, (width - width % 4) / 4, (height - height % 4) / 4, null, 0,
						(width - width % 4) / 4);
				for (int n = 0; n < (height - height % 4) / 4; n++)
				{
					for (int m = 0; m < (width - width % 4) / 4; m++)
		...
		// C:返回新图像
		BufferedImage destImage = new BufferedImage((width - width % 4), (height - height % 4),
				BufferedImage.TYPE_INT_RGB);
